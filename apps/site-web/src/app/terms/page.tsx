    ...
    <section className="mx-auto max-w-4xl px-6 py-20">
      ...
      <div className="space-y-10 text-sm leading-8 text-slate-700">
        ...
        <Section title="一、服务说明">
          ...
          <p className="mt-4">
            本产品的 AI 生成能力由以下已在中国境内完成算法备案的合规服务商提供：
            DeepSeek（深度求索）、阿里云（通义系列）、火山引擎（字节跳动）、可灵 Kling（快手）。
            上述服务商均已按照《互联网信息服务深度合成管理规定》《生成式人工智能服务管理暂行办法》
            等法律法规完成备案，具备合法合规的 AI 服务提供资质。详细信息请参阅《内容政策》。
          </p>
        ...
        <Section title="四、服务使用规范">
          <p>
            您同意在使用本服务时遵守以下规范。<strong>您不得利用 AI 生成功能制作、复制、发布、传播任何违法、侵权或违反社会公序良俗的内容。</strong>
            您对使用本产品生成的所有内容承担全部法律责任。完整禁止内容清单请参阅《内容政策》第三条"禁止内容清单"。
          </p>
        ...
        <Section title="五、内容权属与授权">
          ...
          <SubSection title="5.2 AI 生成结果">
            <p>
              通过本服务生成的视频内容，在您遵守本协议的前提下，您享有对该内容的使用权，
              可用于个人创作、分享及商业用途（除本协议禁止的情形外）。
            </p>
            <p className="mt-2">
              <strong>知识产权归属说明：</strong>
              鉴于 AI 生成内容的著作权认定在全球范围内尚无统一法律标准，本协议对 AI 生成内容的知识产权归属作如下约定：
            </p>
            <ul className="list-disc pl-5 space-y-2 mt-2">
              <li>
                <strong>您的创作贡献：</strong>
                您通过提供原创文字描述（Prompt）、上传自有图片/视频素材、设置创意参数等方式对生成结果作出实质性贡献的部分，
                在适用法律认可的范围内，您保留对该贡献部分的相应权利。
              </li>
              <li>
                <strong>使用权授予：</strong>
                无论 AI 生成内容的知识产权最终如何认定，在您遵守本协议的前提下，我们授予您对该内容的永久、全球、免版税、可转让的使用权。
              </li>
              <li>
                <strong>第三方权益：</strong>
                如 AI 生成内容涉及或近似于第三方已有的作品、肖像、商标或其他受保护权益，
                相关责任由您自行承担。本产品不对生成内容的原创性作任何保证。
              </li>
              <li>
                <strong>相同/相似输出：</strong>
                由于 AI 模型的技术特性，其他用户可能通过本产品生成与您的输出相似或相同的内容，
                您对此予以理解，并同意不因此对我们或该用户主张权利。
              </li>
            </ul>
            <p className="mt-2">
              您理解并同意：AI 生成内容的最终权属认定受不同国家和地区法律管辖的影响，
              我们不对生成内容的版权归属作出任何明确的法律承诺。
            </p>
          </SubSection>
