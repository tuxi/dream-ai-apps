...
export function ShowcasePanel({ features }: { features: SiteFeature[] }) {
  return (
    <section className="mx-auto max-w-6xl px-6 py-20">
      <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <SectionTitle
          eyebrow="Product View"
          title="A website that feels closer to the product direction"
          description="Rather than a generic tool landing page, the site now presents DreamAI as a focused AI video product shaped around creator and commerce storytelling."
        />
          ...
          <div className="relative">
            <div className="rounded-[1.8rem] border border-white/10 bg-white/8 p-5 backdrop-blur">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs uppercase tracking-[0.22em] text-white/60">Workflow canvas</p>
                  <h3 className="mt-2 text-2xl font-semibold">DreamAI creative flows</h3>
                </div>
